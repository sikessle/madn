...
public final class DiceTest {
	...
	public void testThrowDice() {
		assertTrue(dice.rollDice(thrower) >= settings.getDiceMin());
		assertTrue(dice.rollDice(thrower) <= settings.getDiceMax());
	}
